        ...
        <nav class="navbar navbar-dark navbar-expand-md bg-dark py-3 sticky-top">
            <div class="container">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                         ...
                         <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="EliminarPublicacion.jsp">Busqueda Avanzada</a>
                    ...
                    <div class="nuevaPubli"><h1>Busqueda Avanzada</h1> </div>
                    ...
                    <form>
                        <input style="margin-top: 10px" name="txtBusqueda" placeholder="Busqueda Avanzada">
                        <br>
                        <button type="submit" name="busquedaCuerpo" class="btn btn-primary" style="margin: 10px">Cuerpo</button>
                        <button type="submit" name="busquedaEtiqueta" class="btn btn-primary" style="margin: 10px">Etiqueta</button>
                     ...
                     <!<!-- Intento de busqueda -->
  <%
            if (request.getParameter("busquedaCuerpo") != null) {
            ...
            try {
               ...
               rs = st.executeQuery("SELECT * FROM Publicacion where Publicacion.cuerpoPubli like '%" + buscar + "%' AND Publicacion.spoiler = '1';");
                while (rs.next()) {
        %>
...
} else if(request.getParameter("busquedaEtiqueta") != null){ 
        %>
        ...
        <%
            ...
            try {
                ...
                con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ProgramacionWeb?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "Widow1234");
                st = con.createStatement();
                rs = st.executeQuery("SELECT * FROM Publicacion where Publicacion.postEtiqueta like '%" + buscar + "%' AND Publicacion.spoiler = '1';");
                while (rs.next()) 
                {

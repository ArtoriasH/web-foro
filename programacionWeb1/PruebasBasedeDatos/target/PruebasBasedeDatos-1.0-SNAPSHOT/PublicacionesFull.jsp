<%-- 
    Document   : PublicacionesFull
    Created on : Nov 27, 2022, 1:00:31 AM
    Author     : humbe
--%>
...
<html>
    ...
    <body>
        <%
            ...
            String etiqueta = request.getParameter("etiqueta");  // Aqui traigo mi etiqueta pero no se muestra
        %>
        ...
        <div class="nuevaPubli"> 
            ...
            <div class="container">
                ...
                <form method="post">  
                    <textarea id="comentario" name="comentario" placeholder="Texto" style="height:200px" required="required"></textarea>                  
                    <button type="submit" name="comentar" class="btn btn-primary" style="margin: 10px">Comentar</button>
                </form> 
                <%
                    ...
                    try {
                        ...
                        rs = st.executeQuery("SELECT * FROM Comentario where Comentario.idPost = '" + id + "';");
                        while (rs.next()) {
                %>
                <div class="row" style="border:solid; border-color: #b5b5b5;margin-bottom: 20px;" >
                    <div class="col-75">
                        <p><%=rs.getString(4)%><p>                           
        ...
        <%
            if (request.getParameter("comentar") != null) {
                ...
                try {
                    ...
                    con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ProgramacionWeb?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "Widow1234");
                    st = con.createStatement();
                    st.executeUpdate("insert into Comentario (idUsuario,idPost, comentario) values('" + sesion.getAttribute("idUsuario") + "', '" + id + "', '" + comentario + "');");

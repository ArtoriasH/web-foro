<%-- 
    Document   : EliminarPublicacion
    Created on : Nov 26, 2022, 10:51:37 PM
    Author     : humbe
--%>
        ...
        <nav class="navbar navbar-dark navbar-expand-md bg-dark py-3 sticky-top">
            <div class="container">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <div class="nuevaPubli"><h1>Eliminar Publicacion</h1> </div>
                ...
                <div class="row">
                    <div class="col-75">
                        <label><%=rs.getString(5)%></label>
                            <form action="EliminarPublicacion.jsp" method="post">   
                                <textarea style="visibility: hidden"name="identificador"><%=rs.getString(1)%></textarea>
                            
                    <button type="submit" name="eliminar" class="btn btn-primary" style="margin: 10px">Eliminar</button>
                </form> 
        ...
        <%
            if (request.getParameter("eliminar") != null) {
                ...
                try {
                    ...
                    con = DriverManager.getConnection("jdbc:mysql://localhost:3306/ProgramacionWeb?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "Widow1234");
                    st = con.createStatement();
                    st.executeUpdate("update Publicacion set  spoiler= ' 0 ' where idPublicacion='" + id + "';");
